...
import {  WrapperAuthForm, 
          ...
          WrapperModalOverlay} 
from './style';
import { WrapperAuthFormPolicyText } from './style';
import { WrapperAuthFormTextLink } from './style';
          ...
          <WrapperAuthForm className="auth-form">
            <WrapperFormContainer className="auth-form__container">
              <WrapperFormHeader className="auth-form__header">
                  <WrapperFormHeading className="auth-form__heading">Đăng Ký</WrapperFormHeading>
                  <WrapperFormSwitchBtn className="auth-form__switch-btn">Đăng Nhập</WrapperFormSwitchBtn>
              </WrapperFormHeader>
              
              <div className="auth-form__form">
                <InputForm placeholder = "Email của bạn " />
                <InputForm type = "password" placeholder = "Mật khẩu của bạn "/>
                <InputForm type = "password" placeholder = "Nhập lại mật khẩu "/>
              </div>

              <WrapperAuthFormAside className="auth-form__aside">
                <WrapperAuthFormPolicyText class="auth-form__policy-text">
                    Bằng việc đăng ký, bạn đã đồng ý với PHANBON về
                    <WrapperAuthFormTextLink href="" class="auth-form__text-link"> Điều khoản dịch vụ</WrapperAuthFormTextLink> &
                    <WrapperAuthFormTextLink href="" class="auth-form__text-link"> Chính sách bảo mật</WrapperAuthFormTextLink>
                </WrapperAuthFormPolicyText>
              </WrapperAuthFormAside>
              ...
              <WrapperAuthFormControl className="auth-form__controls">
                ...
                <WrapperButtonLogIn className="btn" style={{marginLeft: '8px'}}>ĐĂNG KÝ</WrapperButtonLogIn>
              </WrapperAuthFormControl>
            </WrapperFormContainer>
